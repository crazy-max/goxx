...
1. [Fork](https://github.com/crazy-max/goxx/fork) and clone the repository
2. Create a new branch: `git checkout -b my-branch-name`
3. Make your changes
4. Build the project: `docker buildx bake`
5. Push to your fork and [submit a pull request](https://github.com/crazy-max/goxx/compare)
